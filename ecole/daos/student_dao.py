...
@dataclass
class StudentDao(Dao[Student], ABC):
    ...
    def read(self, id_student: int) -> Optional[Student]:
        """Renvoie l'étudiant' correspondant à l'entité dont l'id est id_student
    ...
    def delete(self, student: Student) -> bool:
        ...
        :param student: adresse dont l'entité Student correspondante est à supprimer
